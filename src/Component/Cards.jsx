...
function Cards() {
    ...
    return (
        ...
        <div className="w-full bg-yellow-400 h-[70vh] flex flex-col justify-center items-center px-4 py-10 lg:px-20 lg:py-20  ">
            <h1 className='text-4xl text-black  text-center '>Psychotalk in News</h1>
